...
/**
 * Generated class for the SupermarPage page.
 *
...
//@IonicPage()
@Component({
  selector: 'page-supermar',
  templateUrl: 'supermar.html',
})
export class SupermarPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public db: AngularFireDatabase, private actionSheetCtrl: ActionSheetController) {
    ...
    this.personsRef.subscribe(resp => {
     ...
     // console.log('resp length', resp.length)
      this.filterBussines = _.filter(resp, { 'business_category': "SuperMarket" });
